...
export const FounderContainer: React.FC = () => {
  return (
    <div className="founder-container bg-[#f5f1eb] px-5">
      {/* Top border */}
      <div className="border-t border-gray-300 mt-6"></div>
      
      {/* Founder name */}
      <h2 className="text-3xl font-medium py-6">Jessie Gabriel</h2>
      ...
      <CollapsibleSection title="ABOUT">
        <div className="space-y-4">
          <p className="text-sm uppercase font-medium">ALL PLACES FOUNDER</p>
